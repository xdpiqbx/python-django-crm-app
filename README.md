...
1. [`pip install django-environ`](https://django-environ.readthedocs.io/en/latest/install.html)
...
In App we already have `./crm_app/urls.py`
...
- URL `path('edit_record/<int:pk>', views.edit_record, name="edit_record"),`
- View
...
{% block content %}
    ...
    <div class="col-md-6 offset-md-3">
        ...
        <form method="POST">
            ...
            <a type="button" href="{% url 'home' %}" class="btn btn-primary">Back</a>
        </form>
    </div>
    {% endif %}
{% endblock %}
